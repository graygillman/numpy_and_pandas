...
"""
print(exams.loc[['b', 'd', 'f', 'g'], ['score', 'qualify']])
...
print(exams[exams.loc[:, 'attempts'] > 2])
...
print(exams[(exams.loc[:, 'score'] >= 15) & (exams.loc[:, 'score'] <= 20)])
...
print(exams.sort_values(by=['attempts', 'name']).reindex(columns=['attempts', 'name', 'qualify', 'score']))